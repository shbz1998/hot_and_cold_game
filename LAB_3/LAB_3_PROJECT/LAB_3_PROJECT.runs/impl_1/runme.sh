...
HD_PWD='C:/Users/malik/Documents/ECE_524/LAB_3/LAB_3_PROJECT/LAB_3_PROJECT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_MODULE_PART_5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_MODULE_PART_5.tcl -notrace
