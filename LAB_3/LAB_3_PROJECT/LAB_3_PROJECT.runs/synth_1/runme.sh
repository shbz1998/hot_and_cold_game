...
HD_PWD='C:/Users/malik/Documents/ECE_524/LAB_3/LAB_3_PROJECT/LAB_3_PROJECT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_MODULE_PART_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_MODULE_PART_5.tcl
